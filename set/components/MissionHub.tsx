...
import { TrendingUp, TrendingDown, DollarSign, Activity, ChevronRight, Maximize2, Minimize2, Globe, Bitcoin, Box, Layers, Building2, Briefcase, Sparkles } from 'lucide-react';
...
const AssetIcon = ({ type }: { type: string }) => {
  switch (type) {
    ...
    case AssetClass.EXOTIC: return <Sparkles size={14} className="text-cyan-400" />;
    case AssetClass.ESTATE: return <Building2 size={14} className="text-rose-400" />;
    case AssetClass.PRIVATE: return <Briefcase size={14} className="text-amber-500" />;
    ...
    <div className="h-full flex flex-col bg-[#050a0f] border border-gray-800 rounded p-4 font-tech overflow-hidden">
      <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-800">
        <div className="flex items-center gap-2 text-emerald-500">
          ...
          <h2 className="text-sm font-bold tracking-[0.2em] uppercase">Global Discovery</h2>
        </div>
        <div className="flex items-center gap-3">
            <span className="text-[10px] text-gray-500 font-mono">ALL_WORLD_UPLINK</span>
            ...
            >
              ...
              <div className="flex justify-between items-start mb-2 relative z-10">
                <div className="flex flex-col">
                    <span className="text-[9px] text-gray-500 font-mono mb-1 uppercase tracking-widest">{asset.type} Matrix</span>
              ...
              <p className="text-[10px] text-gray-500 mb-3 leading-relaxed font-mono line-clamp-2">{mission.description}</p>
              
              <div className="flex items-center justify-between mt-auto">
                <div className="flex items-center gap-1.5 text-[9px] text-gray-400 bg-black/40 px-2 py-1 border border-gray-800">
